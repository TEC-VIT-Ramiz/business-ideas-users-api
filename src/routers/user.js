...
router.patch('/users/me', auth.auth, async (req, res) => {
    ...
    const allowedUpdates = ["weightSal", "weightPro", "weightRes", "weightFin", "counter", "flag2", "trivpro", "trivrnd", "trivfin", "trivsal", "flag", "pair","scoreRnd", "scoreSales", "scoreProduction", "scoreFinance", "currentQuestion", "company"];
